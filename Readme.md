...
Anyway almost all the NRAM aspects are implemented, the only things missing out are cost calculation (that it is in progress, but not useful for this scope) and some plotting functions.
